      ...
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const DownloadsSettings()),
            ),
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const DeezerSettings()),
            ),
          ),
          // Language select
          ListTile(
    ...
    return SimpleDialog(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            'Selecting a new icon will exit the app to apply the change!'.i18n,
      ...
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            leading:
                const LeadingIcon(Icons.file_download, color: Color(0xff2ba766)),
          ),
      ...
      body: ListView(
        children: <Widget>[
          ListTile(
            ...
            subtitle: Text(
              'Not app language, used in headers. Now'.i18n +
                ...
                builder: (context) => SimpleDialog(
                  ...
                  children: List.generate(
                    ...
                    (i) => ListTile(
                      ...
                      onTap: () async {
                        setState(() {
                          settings.deezerLanguage = ContentLanguage.all[i].code;
                        });
                        await settings.save();
                        if (context.mounted) {
                          Navigator.of(context).pop();
          ...
          ListTile(
            ...
            subtitle: Text(
              'Country used in headers. Now'.i18n +
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const TagSelectionScreen()),
            ),
          ),
          ListTile(
          ...
          ListTile(
            ...
            subtitle: Text(
              "WARNING: Resolutions above 1200 aren't officially supported".i18n,
            ),
            leading: const Icon(Icons.image),
            trailing: SizedBox(
              width: 75.0,
...
class _GeneralSettingsState extends State<GeneralSettings> {
  ...
  Future<void> _showAudioOutputDialog() async {
    await showDialog(
      context: context,
          ...
          content: Column(
            ...
            children: [
              RadioListTile<PlaybackMode>(
                ...
                title: Text('Normal'.i18n),
                subtitle: Text('Default stereo playback'.i18n),
              ...
              RadioListTile<PlaybackMode>(
                ...
                groupValue: settings.playbackMode,
                title: Text('Surround'.i18n),
                subtitle: Text('Use surround output when available'.i18n),
                onChanged: (PlaybackMode? mode) async {
                  if (mode == null) return;
                  ...
                  Fluttertoast.showToast(
                    msg: 'Playback mode: Surround'.i18n,
                    gravity: ToastGravity.BOTTOM,
                    toastLength: Toast.LENGTH_SHORT,
                  );
                },
      ...
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            subtitle: Text(
              'Copy userToken/ARL Cookie for use in other apps.'.i18n,
            ),
            leading: const Icon(Icons.lock),
            onTap: () async {
